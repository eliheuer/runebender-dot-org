/* @ts-self-types="./runebender_browser.d.ts" */

export class BrowserEditor {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BrowserEditorFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    pointer(kind, x, y, button, buttons, count, mods, dx, dy) {
        wasm.browsereditor_pointer(this.__wbg_ptr, kind, x, y, button, buttons, count, mods, dx, dy);
    }
    /**
     * @param {number} width
     * @param {number} height
    ...
    state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.browsereditor_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./runebender_browser_bg.js": import0,
    };
}

const BrowserEditorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_browsereditor_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('runebender_browser_bg.wasm?v=b3d372ad292791df', import.meta.url);
    }
    const imports = __wbg_get_imports();
